 ...
 * la columna de tipo Call.Direction de una llamada
 * 
 * @author jmdomingueza
 *
 */
public class DirectionCallCellTableRenderer extends JLabel implements TableCellRenderer {
	
	private static final long serialVersionUID = -4693324413824665224L;

	private static final Log logger = LogFactory.getLog(DirectionCallCellTableRenderer.class);
	 ...
	 */
	public DirectionCallCellTableRenderer() {
		super();
		
		logger.trace("Enter DirectionCallCellTableRenderer");
		setHorizontalAlignment(CENTER);
		setOpaque(true);
		
		logger.trace("Exit DirectionCallCellTableRenderer");
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
		...
		Call.Direction direction = (Call.Direction) value;
	 ...
	 * @return
	 */
	private static Color getColor(Call.Direction direction ) {
