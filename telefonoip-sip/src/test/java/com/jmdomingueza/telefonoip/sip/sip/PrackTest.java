...
/**
 * Unit test for PrackTest.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "classpath:application-context.xml" })
public class PrackTest {

	@Autowired 
	protected RequestFactory requestFactory;
	
	@Test
	public void PrackOk() throws CreateRequestException {
		...
		req = requestFactory.createPrack(uri, callID, cSeq,
		...
		String requestExpect = "PRACK sip:bob@biloxi.com SIP/2.0\r\n"
	...
	public void PrackCreateRequestException() throws CreateRequestException {
		String uri,callID,userFrom,hostFrom,displayFrom,tagFrom,userTo,hostTo,displayTo,tagTo,hostVia,transportVia,branchVia;
		Long cSeq;
		Integer portVia,maxForwards;
		...
		requestFactory.createPrack(uri, callID, cSeq,
											  userFrom,hostFrom, displayFrom, tagFrom,
											  userTo, hostTo, displayTo, tagTo,
											  hostVia, portVia, transportVia, branchVia,
											  maxForwards);
